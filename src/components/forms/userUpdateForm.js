              ...
              <div key={i} className="mb-3">
                {editIndex === i ? (
                  ...
                  <>
                    ...
                    <button className="btn btn-secondary btn-sm" onClick={() => setEditIndex(null)}>Save</button>
                  </>
                ) : (
                  ...
                  <div>
                    ...
                    <button type="button" className="btn btn-info btn-sm" onClick={() => handleEditClick(i)}>Edit</button>
                  </div>
                )}
              </div>
            ))}
