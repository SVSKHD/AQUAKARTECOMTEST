                ...
                <table class="email-container" role="presentation" cellspacing="0" cellpadding="0" border="0" align="center">
                  ...
                  <tr>
                    <td align="center">
                      ...
                      <p>Thank you for signing up for an AquaKart account with the following email:</p>
                      <p><strong>${email}</strong></p>
                      <p>We're excited to have you with us. Start exploring the latest products now!</p>
                      <!-- Social icons -->
