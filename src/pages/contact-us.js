        ...
        <AquaLayout seo={seo}>
            <div className="row mb-3">
                <div className="col-md-6 col-lg-6 col-xs-12 col-sm-12">
                    <AquaStandardShadowCard>
                        <AquaHeading center={true} decorate={true} level={1}>Our Social Handels</AquaHeading>
                ...
                <div className="col-md-6 col-lg-6 col-xs-12 col-sm-12">
                    <AquaStandardShadowCard>
                        <AquaHeading center={true} decorate={true} level={1}>Our Contact Handels</AquaHeading>
                        <div className="text-center">
                            <a
            ...
            <div className="align-contact-card">
                <AquaStandardShadowCard width="400px">
                    <p className="text-muted">We're committed to fostering a strong connection with our users and have provided numerous contact methods for your convenience. Don't hesitate to reach out—we're here to assist you and will respond as swiftly as we can.</p>
                </AquaStandardShadowCard>
            </div>
        </AquaLayout>
    )
